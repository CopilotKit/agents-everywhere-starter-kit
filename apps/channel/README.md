...
| Conversation | [Channel](src/channel.tsx): mention, subscribe, respond to subscribed messages |
| Thread context and research | [Tools](src/tools.tsx): `read_thread` and Exa-backed `search_web` |
| Native cards | [Components](src/components.tsx): incident card and timeline via Channels JSX |
